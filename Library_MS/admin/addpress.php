...
<body>
	...
	<div class="main">
		...
		<div class="main_right">
			<div class="right_top">新增出版社</div>
			<div class="right_cont">
			<form action="doAdminAction.php?act=addpress" method="post" >
				<label for="book">出版社</label>
				<input type="text" name="press" placeholder="请输入出版社" id="book">
				<br />
