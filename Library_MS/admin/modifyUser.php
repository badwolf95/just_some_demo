...
<body>
	...
	<div class="main">
		...
		<div class="main_right">
			<div class="right_top">更新用户信息</div>
			<div class="right_cont">
			<form action="doAdminAction.php?act=modifyUser&id=<?php echo $users['id'];?>" method="post" >
				<label for="book">更改用户名</label>
				<input type="text" name="user" value="<?php echo $users['name'];?>"  id="book">
				<br />
				<label for="book">更改密码</label>
				<input type="text" name="password" id="book">
				<br />
				<label for="book">更换邮箱</label>
				<input type="text" name="email" value="<?php echo $users['email'];?>" id="book">
				<br />
				<label for="book">更换电话</label>
				<input type="text" name="phone" value="<?php echo $users['phone'];?>" id="book">
				<br />
