...
<form action="admin/doAdminAction.php?act=regist" method="post" enctype="multipart/form-data">
	<ul class="login">
        ...
        <li><span class="reg_item"><i>*</i>性别：</span>
        	<input type="radio" value="男" name="sex" id="male" /><lable for="male">男</lable>
        	<input type="radio" value="女" name="sex" id="female"/><lable for="female">女</lable>
        	<input type="radio" value="保密" name="sex" id="secret" checked="checked"/><lable for="secret">保密</lable>
        </li>
        <li>请选择头像：<input type="file" name="face"/></li>
        ...
        <input type="submit" value="submit" class="login_btn"></li>
	</ul>
</form>
</div>
</div>
