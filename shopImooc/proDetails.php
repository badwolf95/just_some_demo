...
$proId = $_REQUEST['id'];
$pics = getPicById($proId);
$proDetail = getProById($proId);
$cate = getCateByCid($proDetail['cId']);
?>
<!doctype html>
<html>
<head>
	...
	<div class="description clearfix">
		<div class="leftArea">
			<div class="description_imgs">
				...
				?>
					...
					echo "admin/".$pic['albumPath'];
					?>" width="50px" height="50px" class="active" alt="one bug"></a></li>
		...
		<div class="rightArea">
			<div class="des_content">
				<h3 class="des_content_tit"><?php echo $proDetail['pName'];?></h3>
				<div class="dl clearfix">
					<div class="dt">慕课价</div>
					<div class="dd clearfix"><span class="des_money"><em>￥</em><?php echo $proDetail['mPrice'];?></span></div>
				</div>
				<div class="dl clearfix">
					<div class="dt">优惠</div>
