...
$cateOne = getCateByCid($proInfo['cId']);
$cates = getAllCate();
?>
<!doctype html>
<html> 
...
<body>
<h3>修改商品信息</h3>
<form action="doAdminAction.php?act=modifyPro&id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
<table width="90%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	...
	<tr>
		...
		<td>
		<select name="cId">
			<option value="<?php echo $cateOne['id'];?>"><?php echo $cateOne['cName'];?></option>
	...
	<tr>
		...
		<td>
			<textarea name="pDesc" id="editor_id" style="width:100%;height:550px;"><?php echo $proInfo['pDesc'];?></textarea>
		</td>
	</tr>
	<tr>
