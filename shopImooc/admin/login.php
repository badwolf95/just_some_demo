...
<div class="loginBox">
	...
	<form method="post" action="doAdminAction.php?act=login_manager" >
		<ul class="login">
			<li class="l_tit">管理员邮箱/用户名/手机号</li>
			<li class="mb_10"><input type="text"  name="username" placeholder="请输入用户名" class="login_input user_icon"></li>
			<li class="l_tit">管理员密码</li>
			<li class="mb_10"><input type="password" name="password" class="login_input user_icon"></li>
			<li class="l_tit">验证码</li>
			<li class="mb_10"><input type="text" name="verification" class="login_input"></li>
